...
<body>
    <form action="{{ route('anggota.store') }}" class="max-w-sm mx-auto" method="POST">
        @csrf
                ...
                <div class="px-6 py-4">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text"
                            ...
                            name="nama" value="{{ old('nama') }}" @error('nama') is-invalid @enderror placeholder="Masukan Nama Anda">
                        @error('nama')
                        ...
                        <input type="text"
                            class="block w-full rounded-md border-0 pl-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            name="hp" id="" value="{{ old('hp') }}"
                            @error('hp') is-invalid @enderror placeholder="Masukan Nomor Hp Anda">
                        @error('hp')
                            <span class="invalid-feedback alert-danger" role="alert">
                                {{ $message }}
                            </span>
